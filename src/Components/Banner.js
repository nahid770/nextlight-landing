...
<div className='mb-20 md:mb-0 '>
    ...
    <div data-aos-duration="2000" data-aos="fade-right" className='md:text-start'>
      ...
      <p className="py-3 mb-4  text-white text-md font-Poppins">The Nextlight is an NFT collection of sunflowers, it symbolizes unwavering faith and unconditional love</p>
      <Link target="_blank" to='https://twitter.com/thelightonsui' className="px-4 py-2 rounded-md border border-yellow-400 text-white btnGradient transition-all text-md font-Poppins bg-gradient-to-r from-[#FF8008] to-[#FFF310]">Start collection</Link>
    </div>
